 ...
 * =========================LICENSE_END==================================
 */
package com.cognifide.cq.apm.core.actions.executor;
...
import com.cognifide.cq.apm.api.exceptions.ActionException;
import com.cognifide.cq.apm.api.executors.Context;

public final class RunActionExecutor extends AbstractActionExecutor {

	public RunActionExecutor(Context context, ActionFactory actionFactory) {
