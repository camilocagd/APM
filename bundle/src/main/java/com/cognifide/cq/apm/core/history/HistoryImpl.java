...
import com.cognifide.cq.apm.api.history.ModifiableEntryBuilder;
...
import com.cognifide.cq.apm.core.scripts.ScriptContent;
import com.cognifide.cq.apm.core.utils.sling.OperateCallback;
import com.cognifide.cq.apm.core.utils.sling.ResolveCallback;
...
public class HistoryImpl implements History {
	...
	public static final String REPLICATE_ACTION = "com/cognifide/actions/apm/history/replicate";
	...
	public Entry find(final String path) {
		return SlingHelper.resolveDefault(resolverFactory, new ResolveCallback<Entry>() {
			...
			public Entry resolve(ResourceResolver resolver) {
				Entry result = null;
				for (String resourcePath : Arrays.asList(path, path.replace("_cqsm", ".apm"))) {
