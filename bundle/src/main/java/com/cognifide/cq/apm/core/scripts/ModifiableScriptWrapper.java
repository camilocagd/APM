...
import com.cognifide.cq.apm.api.scripts.ExecutionMode;
import com.cognifide.cq.apm.api.scripts.ModifiableScript;
import com.cognifide.cq.apm.api.scripts.Script;
import com.cognifide.cq.apm.core.utils.ResourceMixinUtil;
...
public class ModifiableScriptWrapper implements ModifiableScript {
	...
	public void setDryRunStatus(Boolean flag) throws PersistenceException {
		setProperty(ScriptContent.APM_DRY_RUN_SUCCESSFUL, flag);
	}
	...
	public void setDryRunExecution(Date executionDate) throws PersistenceException {
		setProperty(ScriptContent.APM_DRY_RUN_LAST, executionDate);
	}
	...
	public void setProperty(String name, Object value) throws PersistenceException {
		...
		ResourceMixinUtil.addMixin(vm, ScriptContent.APM_FILE);
